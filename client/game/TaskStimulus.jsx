  ...
  render() {
    ...
    return (
        ...
        <div className="task-stimulus">
          ...
          {showA ?
            <div>
              <b>Please write a short love story (at least 100 words).</b> <br/>
              You have 60 minutes.<br/>  
            ...
            :
            <div>
              <b>Please write a short love story (at least 100 words) by editing a draft.</b> <br/>
